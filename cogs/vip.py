...
class vip(interactions.Extension):
	...
	async def vip(self, ctx, sub_command: str):
		...
		if sub_command == "am":
			...
			await ctx.send(embeds=interactions.Embed(description=f"**Приватный сервер в мардер мистери: [Нажми сюда что-бы зайти](https://www.roblox.com/games/142823291?privateServerLinkCode=56639222854899919209021634961802)**"))
